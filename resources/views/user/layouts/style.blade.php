...
<head>
    ...
    <!-- custom css  -->
    <link rel="stylesheet" type="text/css" href="{{ asset('customer/css/list.css') }}">
    <style>
        ...
        <div class="container px-5">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a href="#contact" class="nav-link text-primary"> {{ Auth()->user()->name }} </a></li>
                    <li class="nav-item">
                        <span class="nav-link">
                                <form action="{{ route('logout') }}" method="POST">
                                @csrf 
                                <input type="submit" class="bg-danger text-white outline-0" value="Logout">
                            </form>
                        </span>
